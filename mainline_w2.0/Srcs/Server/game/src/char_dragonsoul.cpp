...
{
	for (int i = INVENTORY_MAX_NUM + WEAR_MAX_NUM; 
		i < INVENTORY_MAX_NUM + WEAR_MAX_NUM + DS_SLOT_MAX * DRAGON_SOUL_DECK_MAX_NUM; i++)
	{
...
bool CHARACTER::DragonSoul_ActivateDeck(int deck_idx)
{
	...
	for (int i = INVENTORY_MAX_NUM + WEAR_MAX_NUM + DS_SLOT_MAX * deck_idx; 
		i < INVENTORY_MAX_NUM + WEAR_MAX_NUM + DS_SLOT_MAX * (deck_idx + 1); i++)
	{
