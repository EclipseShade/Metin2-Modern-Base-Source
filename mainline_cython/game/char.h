...
typedef struct character_point_instant
{
	...
	LPITEM			pItems[INVENTORY_MAX_NUM + WEAR_MAX_NUM + DS_SLOT_MAX * DRAGON_SOUL_DECK_MAX_NUM];
	BYTE			bItemGrid[INVENTORY_MAX_NUM + WEAR_MAX_NUM + DS_SLOT_MAX * DRAGON_SOUL_DECK_MAX_NUM];
